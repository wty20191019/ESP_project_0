...
static const ci_item_t s_ci[] = {
    ...
    { "rx_parse_ms",    CI_U32,   &cfg.rx_parse_ms,          0, 5000, 100, 0, NULL, 0, 0 },
    { "tx_enable",      CI_BOOL,  &cfg.tx_enable,            0,0,0, 0, NULL, 0, 0 },
    { "rx_enable",      CI_BOOL,  &cfg.rx_enable,            0,0,0, 0, NULL, 0, 0 },
    { "rx_parse_ms",    CI_U32,   &cfg.rx_parse_ms,          0, 5000, 100, 0, NULL, 0, 0 },
    ...
    { "rx_f_min",       CI_FLOAT, &cfg.rx_f_min,             0, 3000, 50, 0, NULL, 0, 0 },
    { "rx_f_max",       CI_FLOAT, &cfg.rx_f_max,           100, 5000, 50, 0, NULL, 0, 0 },
